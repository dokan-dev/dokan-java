...
/**
 * If a method is marked with this annotation it won't be registered in DokanyOperations struct.
 * <p>
 * This annotation is not inheritable, so all overridden method will be registered.
 * <p>
 * The goal of this annotation is performance, if the method is not registered in the DokanyOperations struct
