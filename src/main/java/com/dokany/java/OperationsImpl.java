...
abstract class OperationsImpl<TItem> extends Operations {
	...
	private class ZwCreateFile implements Operations.ZwCreateFileDelegate {
		@Override
		public long callback(final WString rawFileName, final IntByReference securityContext, final int rawDesiredAccess, final int rawFileAttributes, final int rawShareAccess, final int rawCreateDisposition, final int rawCreateOptions,
			...
			System.out.println("--------------------------------------------");
			try {
				System.out.println("%%%%%%%%%%%%%% CREATEFILE: rawFileName=" + rawFileName.toString() + " : rawDesiredAccess=" + rawDesiredAccess + " : rawFileAttributes=" + rawFileAttributes + " : rawShareAccess=" + rawShareAccess
				        + " : rawCreateDisposition=" + rawCreateDisposition + " : rawCreateOptions=" + rawCreateOptions + " : isDirectory=" + isDirectory);
				final OpenFileResult<TItem> result = fs.createFile(rawFileName.toString(), securityContext.getValue(), rawDesiredAccess, rawFileAttributes, rawShareAccess, rawCreateDisposition, rawCreateOptions,
				        isDirectory);
	...
	private class GetVolumeInformation implements Operations.GetVolumeInformationDelegate {
		@Override
		public long callback(final Pointer volumeNameBuffer, final int volumeNameSize, final IntByReference rawVolumeSerialNumber,
		        final IntByReference rawMaximumComponentLength,
		        final IntByReference rawFileSystemFlags,
		        final Pointer rawFileSystemNameBuffer, final int rawFileSystemNameSize,
	...
	private class GetDiskFreeSpace implements Operations.GetDiskFreeSpaceDelegate {
		@Override
		public long callback(final LongByReference rawFreeBytesAvailable, final LongByReference rawTotalNumberOfBytes, final LongByReference rawTotalNumberOfFreeBytes, final FileInfoRaw rawFileInfo) {
	...
	private class FindFilesWithPattern implements Operations.FindFilesWithPatternDelegate {
		@Override
		public long callback(final WString fileName, final WString searchPattern, final Operations.FillWin32FindData rawFillFindData, final FileInfoRaw rawFileInfo) {
	...
	private class ReadFile implements Operations.ReadFileDelegate {
		@Override
		public long callback(final WString fileName, final Pointer buffer, final int bufferLength, final IntByReference readLength, final long offset, final FileInfoRaw rawFileInfo) {
	...
	private class WriteFile implements Operations.WriteFileDelegate {
		@Override
		public long callback(final WString fileName, final Pointer buffer, final int numberOfBytesToWrite, final IntByReference numberOfBytesWritten, final long offset, final FileInfoRaw rawFileInfo) {
	...
	private class FlushFileBuffers implements Operations.FlushFileBuffersDelegate {
		@Override
		public long callback(final WString fileName, final FileInfoRaw rawFileInfo) {
	...
	private class GetFileInformation implements Operations.GetFileInformationDelegate {
		@Override
		public long callback(final WString fileName, final ByHandleFileInformation handleFileInfo, final FileInfoRaw rawFileInfo) {
	...
	private class SetFileAttributes implements Operations.SetFileAttributesDelegate {
		@Override
		public long callback(final WString fileName, final int attributes, final FileInfoRaw rawFileInfo) {
	...
	private class SetFileTime implements Operations.SetFileTimeDelegate {
		@Override
		public long callback(final WString fileName, final FileTime creationTime, final FileTime lastAccessTime, final FileTime lastWriteTime, final FileInfoRaw rawFileInfo) {
	...
	private class FindStreams implements Operations.FindStreamsDelegate {
		@Override
		public long callback(final WString fileName, final Operations.FillWin32FindStreamData fill, final FileInfoRaw rawFileInfo) {
	...
	private class GetFileSecurity implements Operations.GetFileSecurityDelegate {
		@Override
		public long callback(final WString fileName, final int rawRequestedInformation, final Pointer rawSecurityDescriptor, final int rawSecurityDescriptorLength, final IntByReference rawSecurityDescriptorLengthNeeded,
		        final FileInfoRaw rawFileInfo) {
	...
	private class SetFileSecurity implements Operations.SetFileSecurityDelegate {
		@Override
		public long callback(final WString fileName, final int rawSecurityInformation, final Pointer rawSecurityDescriptor, final int rawSecurityDescriptorLength, final FileInfoRaw rawFileInfo) {
	...
	private class MoveFile implements Operations.MoveFileDelegate {
		@Override
		public long callback(final WString oldFileName, final WString newFileName, final boolean replaceIfExisting, final FileInfoRaw rawFileInfo) {
	...
	private class SetAllocationSize implements Operations.SetAllocationSizeDelegate {
		@Override
		public long callback(final WString fileName, final long length, final FileInfoRaw rawFileInfo) {
	...
	private class LockFile implements Operations.LockFileDelegate {
		@Override
		public long callback(final WString fileName, final long byteOffset, final long length, final FileInfoRaw rawFileInfo) {
